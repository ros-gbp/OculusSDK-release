...
User `dgossow@lex` released the packages in the `oculus_sdk` repository by running `/usr/bin/bloom-release --track groovy --ros-distro groovy --edit oculus_sdk` on `Wed, 21 Aug 2013 23:29:03 -0000`
...
User `dgossow@lex` released the packages in the `oculus_sdk` repository by running `/usr/bin/bloom-release --track groovy --ros-distro groovy oculus_sdk` on `Wed, 21 Aug 2013 23:19:14 -0000`
...
User `dgossow@lex` released the packages in the `oculus_sdk` repository by running `/usr/bin/bloom-release --track groovy --ros-distro groovy oculus_sdk` on `Wed, 21 Aug 2013 21:56:01 -0000`
...
User `dgossow@lex` released the packages in the `oculus_sdk` repository by running `/usr/bin/bloom-release --track groovy --ros-distro groovy --new-track oculus_sdk` on `Wed, 21 Aug 2013 16:54:46 -0000`
...
User `dgossow@lex` released the packages in the `oculus_sdk` repository by running `/usr/bin/bloom-release --track hydro --ros-distro hydro --new-track oculus_sdk` on `Fri, 16 Aug 2013 20:18:03 -0000`

The `oculus_sdk` package was released.

Version of package(s) in repository `oculus_sdk`:
- rosdistro version: `0.2.3-4`
- old version: `0.2.3-5`
- new version: `0.2.3-6`
